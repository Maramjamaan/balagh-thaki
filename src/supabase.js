// ============================================
// supabase.js — Demo Mode للهاكاثون
// ============================================
// في الإنتاج: فعّل الاتصال بـ Supabase الحقيقي
// الحين: نستخدم in-memory store عشان ما فيه أخطاء
...
console.log('ℹ️ Awla Demo Mode — بيانات تجريبية لحفريات الرياض');
