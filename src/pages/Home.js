      ...
      <section style={s.section}>
        ...
        <div style={s.statsGrid}>
          {[
            ...
            { icon: '⏱️', value: '+30', label: 'حفريات متأخرة', color: '#ffc300' },
      ...
      <section style={{ ...s.section, background: '#F5F1ED' }}>
        ...
        <div style={s.featGrid}>
          {[
            ...
            { icon: '⏱️', title: 'عداد تنازلي للحفريات', desc: 'تتبع مدة التراخيص ومعرفة الحفريات المتأخرة عن موعدها', border: '#ffc300' },
      ...
      <section style={s.section}>
        ...
        <div style={s.catGrid}>
          {[
            ...
            { icon: '💡', title: 'بنية تحتية', desc: 'مياه، كهرباء، إنارة، وأرصفة', bg: 'linear-gradient(135deg, #ffc300, #B8956F)' },
...
const s = {
  ...
  cta: {
    padding: '80px 20px',
    textAlign: 'center',
    background: 'linear-gradient(135deg, #1B7F5F 0%, #ffc300 50%, #D4A574 100%)',
  },
  ctaBtn: {
    display: 'inline-flex',
    alignItems: 'center',
